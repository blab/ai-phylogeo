## Code to create reliability diagrams for calibrated data (20k dataset)
...
plot <- reliabilityChart(calibrated, "Reliability Plots for Calibrated Data")

ggsave("figure10.png", plot, width = 11, height = 4)
