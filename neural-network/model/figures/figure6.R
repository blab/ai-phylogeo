## Code to create boxplots of the ratio between predicted probabilities for calibrated data (20k dataset)
...
plot <- comparisonData(calibrated, "Ratio Between Predicted Probabilities, Calibrated Model")

ggsave("figure6.png", plot, width = 9, height = 6)
